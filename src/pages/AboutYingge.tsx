...
export function AboutYingge() {
  ...
  return (
    <div className="min-h-screen bg-yingge-gray">
              ...
              {aboutData.history.map((item, index) => (
                ...
                >
                  ...
                  <div className={`w-full md:w-1/2 ${index % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16'}`}>
                    <div className={`bg-white rounded-xl card-shadow p-6 ${index % 2 === 0 ? 'md:ml-auto' : ''}`}>
      ...
      <section className="py-16 px-4 bg-gradient-to-b from-yingge-light to-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="font-serif font-bold text-3xl text-yingge-dark mb-4">
              普宁英歌特色
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {aboutData.puningFeatures.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-xl card-shadow p-6 text-center hover:card-shadow-hover transition-all duration-300 animate-slide-up"
                  style={{ animationDelay: `${index * 100}ms` }}
                >
